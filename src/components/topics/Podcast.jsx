        ...
        <Card className="container custom-card">
          <Card.Body>
            ...
            <Card.Text className="paragraph-indent">
              ...
              how important teamwork and communication are between these two
              ...
              reprocessing. Understanding how both departments rely on each
              other helped me see how important collaboration is in maintaining
              patient safety.
            </Card.Text>
            <Card.Text className="paragraph-indent">
              I also learned that cross-training between OR and SPD staff can
              help both departments better understand each other’s roles. When
              ...
              and sterilization processes performed in SPD, they gain a better
              appreciation for the time, effort, and attention required to
              prepare instruments safely. This type of shared knowledge can
            ...
            <Card.Text className="paragraph-indent">
              ...
              other’s processes, they are more likely to recognize potential
              problems early, such as missing instruments, damaged equipment, or
              improper handling. This can help prevent errors, reduce delays
              during surgery, and ensure that sterile instruments are available
              when needed. Learning about the connection between OR and SPD
